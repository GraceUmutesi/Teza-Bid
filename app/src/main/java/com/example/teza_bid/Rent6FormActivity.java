...
public class Rent6FormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent6_form);
        ...
        mButtoon.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent rent1 = new Intent(Rent6FormActivity.this,LoginActivityForBuyer.class);
                startActivity(rent1);
            }
    ...
    class MyAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            View row = layoutInflater.inflate(R.layout.activity_rent6_form, parent, false);
