...
public class Rent2FormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rent2_form);
        ...
        mButtonn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent rent2 = new Intent(Rent2FormActivity.this,LoginActivityForBuyer.class);
                startActivity(rent2);
            }
    ...
    class MyAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            View row = layoutInflater.inflate(R.layout.activity_rent2_form, parent, false);
